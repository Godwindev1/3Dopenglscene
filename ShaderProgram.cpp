...
void  ShaderProgram::checkCompileErrors(GLuint shader, ShaderType type)
{
	...
	else
	{
		...
		if (status == GL_FALSE)
		{
			...
			std::cerr <<  (type == VERTEX ? "Vertex Shader: " : (type == FRAGMENT ? "Fragment shader: " : "Geometry Shader: ")) << "Error! Shader failed to compile. " << errorLog << std::endl;
		}
	}
